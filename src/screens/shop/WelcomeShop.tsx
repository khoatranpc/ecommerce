...
const WelcomeShop = () => {
      ...
      >
        <div className="space-y-4 mt-8">
          ...
          <Paragraph className="text-gray-500">
            Bắt đầu hành trình kinh doanh của bạn bằng cách thiết lập thông tin
            cửa hàng. Chúng tôi sẽ giúp bạn xây dựng cửa hàng trực tuyến một
            cách dễ dàng và chuyên nghiệp.
          </Paragraph>
  ...
  return hasShopInfo ? <ExistingShopView /> : <NoShopView />;
};
